    ...
    return (
        <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Adding Product..." })} className="text-slate-500 mb-28">
            ...
            <div className="flex gap-5 flex-wrap">
                ...
                <label htmlFor="" className="flex flex-col gap-2 ">
                    Stock (Units)
                    <input type="number" name="stock" max="50" min="0" onChange={onChangeHandler} value={productInfo.stock} placeholder="0" className="w-full max-w-45 p-2 px-4 outline-none border border-slate-200 rounded resize-none" required />
                </label>
            </div>
