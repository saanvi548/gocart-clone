...
const WStoreSidebar = ({storeInfo}) => {

    const pathname = usePathname()

    const sidebarLinks = [
        { name: 'Dashboard', href: '/wholesale', icon: HomeIcon },
        { name: 'Add Product', href: '/wholesale/add-product', icon: SquarePlusIcon },
        { name: 'Manage Product', href: '/wholesale/manage-product', icon: SquarePenIcon },
        { name: 'Orders', href: '/wholesale/orders', icon: LayoutListIcon },
    ]
